...
import 'package:smart_parking/model/polyline_response.dart';
...
class _PolylineScreenState extends State<PolylineScreen> {
  ...
  String totalDistance = "50"; //only for display
  String totalTime = "50";

  String apiKey = "AIzaSyDHvymtZYto_5ShBhQKNpnBen1vPrHOo_0";
